...
class MainPage4 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final highestDay = _getHighestEmotionDay(emotionData, 'unrest');
                                            ...
                                            children: [
                                              ...
                                              TextSpan(
                                                ...
                                                style: TextStyle(
                                                  ...
                                                  height: 30 / 25, // line-height를 반영하기 위해 fontSize로 나누어줌
                                                  letterSpacing: -0.05,
                                                  color: Color(0xFF30B3FC), // 기쁨도의 색상
                                                ),
                                              ),
                                              TextSpan(
                                                text: ' 높아요',
                                    ...
                                    child: Row(
                                      ...
                                      children: List.generate(emotionData.length, (index) {
                                        ...
                                        return _buildBar(
                                          ...
                                          dateData['unrest'].toInt(),
                                          dateData['unrest'] == _getHighestValue(emotionData, 'unrest'),
                                          100,
                                        );
                                      }),
                                    ),
    ...
    return Row(
      ...
      children: List.generate(4, (index) {
        return AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: currentPage == index ? Color(0xFF30B3FC) : Colors.grey, // 기쁨도 색상으로 인디케이터 설정
        ...
        Stack(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                color: isMax ? Color(0xFF30B3FC) : Colors.transparent, // 최대값만 색상 적용
                border: Border.all(
                  color: Color(0xFF30B3FC),
                  width: 1.5,
                ),
