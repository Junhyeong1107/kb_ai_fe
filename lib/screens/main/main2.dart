...
class MainPage2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final highestDay = _getHighestEmotionDay(emotionData, 'anger');
                                            ...
                                            children: [
                                              ...
                                              TextSpan(
                                                ...
                                                style: TextStyle(
                                                  ...
                                                  height: 30 / 25, // line-height를 반영하기 위해 fontSize로 나누어줌
                                                  letterSpacing: -0.05,
                                                  color: Color(0xFFFF5000), // 분노도의 색상
                                                ),
                                              ),
                                              TextSpan(
                                                text: ' 높아요',
                                    ...
                                    child: Row(
                                      ...
                                      children: List.generate(emotionData.length, (index) {
                                        ...
                                        return _buildBar(
                                          ...
                                          dateData['anger'].toInt(),
                                          dateData['anger'] == _getHighestValue(emotionData, 'anger'),
                                          100,
                                        );
                                      }),
                                    ),
    ...
    return Row(
      ...
      children: List.generate(4, (index) {
        return AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: currentPage == index ?  Color(0xFFFF5000) : Colors.grey, // 기쁨도 색상으로 인디케이터 설정
        ...
        Stack(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                color: isMax ? Color(0xFFFF5000) : Colors.transparent, // 최대값만 색상 적용
                border: Border.all(
